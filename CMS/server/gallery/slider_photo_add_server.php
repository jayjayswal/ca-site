...
$a= new Slider_PhotoClass(NULL, $imageurl, $sc_name, $sc_caption, "1");
echo $a->UploadPhotos($imageurl, $sc_name, $sc_caption);
$l=new site_log(NULL, NULL,$_SESSION['user']->username, $_SERVER['REMOTE_ADDR'], $sc_caption." slider photo added");
$l->insertlog();
?>