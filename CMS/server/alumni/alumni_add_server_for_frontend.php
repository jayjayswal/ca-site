...
$privatekey = "6LdP8-sSAAAAALXj3amYVgEz_Q2g7I5AdG1cxzdv";
...
$alu=new Alumni_Detail($username, $fname, $lname, $email, $linkedin_id, $rurl, $batch, $imageurl, $password,"0");
...
//
$l=new site_log(NULL, NULL,"Alumni request", $_SERVER['REMOTE_ADDR'], $fname." alumni added");
$l->insertlog();
?>