...
$desi=new faculty_experience_class(NULL,$faculty_id,$ins_name, $year, $desig);
echo $desi->insertExperience();

$l=new site_log(NULL, NULL,$_SESSION['user']->username, $_SERVER['REMOTE_ADDR'], $faculty_id." experience added");
$l->insertlog();
