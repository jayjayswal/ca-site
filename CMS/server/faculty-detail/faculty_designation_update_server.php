...
$desi=new faculty_designation_class($designation_id,$designation_name,$designation_level);
echo $desi->updateDesig();

$l=new site_log(NULL, NULL,$_SESSION['user']->username, $_SERVER['REMOTE_ADDR'], $designation_id." designation updated");
$l->insertlog();
