...
if(isset($_POST['faculty_id']))
{
    ...
    $obj=  faculty_detail_class::getFacultyObject($faculty_id);
}
else
{
    die("id needed.");
...
echo $fa->updateFaculty();

$l=new site_log(NULL, NULL,$_SESSION['user']->username, $_SERVER['REMOTE_ADDR'], $faculty_id." faculty updated");
$l->insertlog();
