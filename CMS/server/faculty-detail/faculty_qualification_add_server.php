...
$desi=new faculty_qualification_class(NULL, $faculty_id, $dname,$year ,$ins_name);
echo $desi->insertQualification();

$l=new site_log(NULL, NULL,$_SESSION['user']->username, $_SERVER['REMOTE_ADDR'], $faculty_id." qualification added");
$l->insertlog();
