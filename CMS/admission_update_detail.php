...
?>
                    ...
                    <li><a href="admission_add_detail.php">Add Admission Detail</a></li>
                    <li><a href="admission_manage_detail.php">Manage Admission detail</a></li>
       ...
       <div id="content">             
           <div style="margin-left:10px;">
            ...
            <p id="validateTips" class="validateTips" style="font-size:15px"></p>
                ...
                <?php include('server/gen-detail/admission_update_detail_form.php');
                ?>
        </div>
