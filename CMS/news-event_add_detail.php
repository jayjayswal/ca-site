...
?>
                    ...
                    <li><a href="news-event_add_detail.php">Add News/Events</a></li>
                    <li><a href="news-event_manage_detail.php">Manage News/Events</a></li>
         ...
         $(document).ready(function(){
             ...
             $("#addNE").submit(function(e)
            {
                ...
                success: function(data, textStatus, jqXHR)
                {
                   if(data==1)
                       {
                           updateTips("News Inserted");
                           document.getElementById("addNE").reset();
                       }
                       else
                           {
                               updateerror(data);
       ...
       <div id="content">             
           <div style="margin-left:10px;">
            ...
            <p id="validateTips" class="validateTips" style="font-size:15px"></p>
                ...
                <?php include('server/news-event/news_add_form.php');
                ?>
        </div>
