...
?>
                    ...
                    <li><a href="horizon_add_issue.php">Add Horizon Issue</a></li>
                    <li><a href="horizon_manage_detail.php">Manage Horizon Issue</a></li>
       ...
       <div id="content">             
           <div style="margin-left:10px;">
            ...
            <p id="validateTips" class="validateTips" style="font-size:15px"></p>
                ...
                <?php include('server/horizon/horizon_add_form.php');
                ?>
        </div>
        </div>
