...
$user = $_SESSION['user'];
   ...
   elseif ($user->role_id==4) {
        require_once 'includes/photohead.php';
    }
 else {
...
?>
                    ...
                    <li><a href="category_add_detail.php">Add Category</a></li>
                    <li><a href="cagegory_manage_detail.php">Manage Category</a></li>
    ...
    <article>
       <div id="content">       
           <div class="CSSTable"  style="margin-left:10px;">
                ...
                <?php include('server/gallery/category_manage_detaill_form.php');
