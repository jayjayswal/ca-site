...
?>
                    ...
                    <li><a href="student_add_detail.php">Add Student</a></li>
                    <li><a href="student_manage_detail.php">Edit/Delete Student</a></li>
       ...
       <div id="content">             
           <div style="margin-left:10px;">
            ...
            <p id="validateTips" class="validateTips" style="font-size:15px"></p>
                ...
                <?php include('server/student/student_add_form.php');
                ?>
        </div>
