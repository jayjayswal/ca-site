    ...
    <script>
     ...
     <script>
            ...
            function checkuname()
            {
                ...
                xmlhttp.open("GET","server/users/user_checkAvalibility.php?uname="+uname,true);
                xmlhttp.send();
            }
         ...
         $(document).ready(function(){
            ...
            {
                var pas=document.addform.password.value;
                var formObj = $(this);
       ...
       <div id="content">             
           <div style="margin-left:10px;">
            ...
            <p id="validateTips" class="validateTips" style="font-size:15px"></p>
                ...
                <?php include('server/users/add_user_form.php');
                ?>
        </div>
        </div>
