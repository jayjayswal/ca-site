    ...
    <script>
     ...
     <script>        
         $(document).ready(function(){
            ...
            {
                var r=confirm("Are you sure you want to send this reply to visitor?");
                if (r==false)
                  {
                      e.preventDefault();
                      return;
                ...
                success: function(data, textStatus, jqXHR)
                {
                   if(data==1)
                       {
                           alert("Reply sent");
                           window.location = 'query_manage_detail.php'
                       }
                       else
                       {
                           updateerror(data);
       ...
       <div id="content">             
           <div style="margin-left:10px;">
            ...
            <p id="validateTips" class="validateTips" style="font-size:15px"></p>
                ...
                <?php include('server/query-feedback/query_reply_form.php');
                ?>
        </div>
        </div>
